...
map.getView().fit([-8373022.448771, 493244.846490, -8372711.037984, 493382.814287], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MURALES UT CAMPUS SANTA HELENA </h2>';
        return titleElement;
    })(),
